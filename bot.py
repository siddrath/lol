...
bot = commands.Bot(description='garry can do a lot more.....', command_prefix=commands.when_mentioned_or('p?'))
...
async def on_guild_join(guild):
    ...
    if general and general.permissions_for(guild.me).send_messages:
        if general and general.permissions_for(guild.me).send_messages:
            await general.send('Hello Greetings! My name is Isse, and my sole responsibility is to help you {}!'.format(guild.name))
